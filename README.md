...
├── .functionality-baseline.json                    # JSON configuration or data file
├── .functionality-baseline.json.backup-1756874649
├── .functionality-baseline.json.backup-1756874716
...
│   ├── functionality-guard.sh                      # Shell script
...
└── .warp/                                          # Warp.dev AI configuration and context
    ├── ai-safety-rules.md                          # Markdown documentation file
