...
echo ""
echo "To disable the hooks temporarily (NOT RECOMMENDED):"
echo "  git config core.hooksPath '' # Temporarily disable hooks"
echo "  # NOTE: Security bypass is prohibited - fix issues instead"
echo ""
